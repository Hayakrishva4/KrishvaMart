        ...
        <div class="auth-header">
            <div class="mascot-container" id="mascotBox">
                <svg id="ai-mascot" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient id="mascotShell" x1="0" y1="0" x2="1" y2="1">
                    ...
                    <g id="mascot-body">
                        <path d="M66 35 L74 24 H126 L134 35" fill="none" stroke="var(--primary)" stroke-width="3" stroke-linecap="round" opacity="0.7"/>
                        <rect x="38" y="35" width="124" height="98" rx="28" fill="url(#mascotShell)" stroke="var(--primary)" stroke-width="4.5" filter="drop-shadow(0 6px 16px rgba(0,0,0,0.12))"/>
                        <line x1="100" y1="35" x2="100" y2="20" stroke="var(--primary)" stroke-width="4" stroke-linecap="round"/>
                        <circle cx="100" cy="16" r="4.5" fill="var(--primary)" filter="url(#neonGlow)"/>
                        <circle cx="54" cy="57" r="3" fill="var(--primary)" opacity="0.8"/>
                        <circle cx="146" cy="57" r="3" fill="var(--primary)" opacity="0.8"/>
                        <rect x="52" y="48" width="96" height="68" rx="14" fill="url(#screenGlow)" stroke="rgba(255,255,255,0.16)" stroke-width="1.5"/>
                        <g id="mascot-eyes" style="transition: transform 0.15s cubic-bezier(0.25, 1, 0.5, 1);">
                            <rect x="68" y="68" width="18" height="28" rx="9" fill="var(--primary)" filter="url(#neonGlow)"/>
                            <rect x="114" y="68" width="18" height="28" rx="9" fill="var(--primary)" filter="url(#neonGlow)"/>
                        </g>
