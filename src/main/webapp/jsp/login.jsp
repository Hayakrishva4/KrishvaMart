    ...
    <div class="login-card">   
            ...
            <div class="brand-content">
                <div class="mascot-container" id="mascotBox" title="Click me to blink!">
                    <svg id="ai-mascot" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <filter id="neonGlowLogin" x="-30%" y="-30%" width="160%" height="160%">
                        ...
                        <g id="mascot-body">
                            ...
                            <circle cx="100" cy="16" r="4.5" fill="#ffffff" filter="url(#neonGlowLogin)"/>
                            ...
                            <g id="mascot-eyes" style="transform-origin: 100px 82px; transition: transform 0.15s cubic-bezier(0.25, 1, 0.5, 1);">
                                <rect x="68" y="68" width="18" height="28" rx="9" fill="var(--primary)" filter="url(#neonGlowLogin)"/>
                                <rect x="114" y="68" width="18" height="28" rx="9" fill="var(--primary)" filter="url(#neonGlowLogin)"/>
                            </g>
                ...
                <p class="brand-text">Sign in to manage your Orders, Cart, and Dashboard seamlessly.</p>
            </div>
        </section>
        <section class="login-form-section">
            <div class="form-heading">
                ...
                <p>Enter your credentials to Browse shopping!</p>
            </div>
            <form id="loginForm">
            ...
            <p id="loginError" class="form-error" style="text-align:center; margin-top:6px;"></p>
