...
public final class JsonUtil 
{
 ...
 public static void writeSuccess(HttpServletResponse resp, int status, Object data) 
  throws IOException 
  {
 ...
 public static void writeError(HttpServletResponse resp, int status, String code, String message) 
  throws IOException 
  {
    ...
    private static void write(HttpServletResponse resp, int status, ApiResponse<?> body)
     throws IOException 
      {
