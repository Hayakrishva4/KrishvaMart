...
public final class SellerSalesSummaryDTO 
{
    ...
    private SellerSalesSummaryDTO(Builder b) 
    {
        ...
        this.byProduct = b.byProduct == null ? List.of() : List.copyOf(b.byProduct);
    }
    ...
    {
     return byProduct == null ? List.of() : Collections.unmodifiableList(byProduct);
    }
    public static final class Builder 
    {
        ...
        {
            this.byProduct = byProduct == null ? List.of() : List.copyOf(byProduct);
            return this;
        }
