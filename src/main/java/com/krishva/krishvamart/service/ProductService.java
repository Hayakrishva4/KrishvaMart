...
public class ProductService {
    ...
    public Product create(
            ...
            Integer stockQty,
            String category,
            String imageUrl) throws AppException {
    ...
    public List<Product> search(
            String keyword,
            String category) throws AppException {

        return productDAO.search(keyword, category, true);
    }

    public PagedResult<Product> search(
            ProductSearchCriteria criteria) throws AppException {

        return productDAO.search(criteria);
    }

    public List<Product> listForSeller(long sellerId)
            throws AppException {

        return productDAO.findBySeller(sellerId);
    }

    public void moderateRemove(
            long productId,
